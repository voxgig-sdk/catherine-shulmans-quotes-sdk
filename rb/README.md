# CatherineShulmansQuotes Ruby SDK



The Ruby SDK for the CatherineShulmansQuotes API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CatherineShulmansQuotesError` (a `StandardError` subclass), so wrap
...
```
rb/
├── CatherineShulmansQuotes_sdk.rb       -- Main SDK module
