...
class QuoteEntity
  ...
  # Load a single Quote.
  #
  # @param reqmatch [QuoteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Quote.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Quote, Hash] the loaded Quote; raises CatherineShulmansQuotesError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Quote>, Array] the matching Quote items; raises CatherineShulmansQuotesError on failure
