...
class EpisodeEntity
  ...
  # @return [Episode, Hash] the loaded Episode; raises CatherineShulmansQuotesError on failure
  ...
  #
  # @param reqmatch [EpisodeListMatch, Hash, nil] match filter (any subset of
  #   Episode fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Episode>, Array] the matching Episode items; raises CatherineShulmansQuotesError on failure
