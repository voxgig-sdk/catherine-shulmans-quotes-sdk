...
class GithubLanguageEntity
  ...
  def make
    opts = @_entopts.dup
    GithubLanguageEntity.new(@_client, opts)
  end
  ...
  # @return [GithubLanguage, Hash] the current GithubLanguage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GithubLanguage fields)
  def match_get
  ...
  #
  # @param reqmatch [GithubLanguageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GithubLanguage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GithubLanguage, Hash] the loaded GithubLanguage; raises CatherineShulmansQuotesError on failure
