...
class GithubCardEntity
  ...
  def make
    opts = @_entopts.dup
    GithubCardEntity.new(@_client, opts)
  end
  ...
  # @return [GithubCard, Hash] the current GithubCard data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GithubCard fields)
  def match_get
  ...
  #
  # @param reqmatch [GithubCardLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GithubCard.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GithubCard, Hash] the loaded GithubCard; raises CatherineShulmansQuotesError on failure
