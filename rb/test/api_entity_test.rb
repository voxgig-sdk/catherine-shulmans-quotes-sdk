...
class ApiEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CATHERINESHULMANSQUOTES_TEST_API_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def api_basic_setup(extra)
  ...
  entid_env_raw = ENV["CATHERINESHULMANSQUOTES_TEST_API_ENTID"]
