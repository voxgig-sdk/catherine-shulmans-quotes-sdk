...
#      offline in seeded test mode (CatherineShulmansQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CatherineShulmansQuotes_sdk.rb")
  SDK_CLASS = "CatherineShulmansQuotesSDK"
  ...
  SDK_BASE = "CatherineShulmansQuotes_sdk"
