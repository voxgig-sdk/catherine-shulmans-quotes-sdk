...
class QuoteEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def quote_basic_setup(extra)
  ...
  entid_env_raw = ENV["CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID"]
