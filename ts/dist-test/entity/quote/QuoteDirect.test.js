...
(0, node_test_1.describe)('QuoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-quote', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-quote', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID'];
