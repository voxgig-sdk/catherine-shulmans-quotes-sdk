...
(0, node_test_1.describe)('GithubLanguageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'github_language.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_LANGUAGE_ENTID JSON to run live');
            return;
        }
        ...
        let github_language_ref01_data = Object.values(setup.data.existing.github_language)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/github_language/GithubLanguageTestData.json');
    ...
    let idmap = transform(['github_language01', 'github_language02', 'github_language03', 'github01', 'github02', 'github03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_LANGUAGE_ENTID'];
...
//# sourceMappingURL=GithubLanguageEntity.test.js.map