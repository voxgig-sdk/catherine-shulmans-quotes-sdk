...
(0, node_test_1.describe)('GithubLanguageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-github_language', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-github_language', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_LANGUAGE_ENTID'];
...
//# sourceMappingURL=GithubLanguageDirect.test.js.map