...
const CatherineShulmansQuotesError_1 = require("./CatherineShulmansQuotesError");
...
class Context {
    ...
    error(code, msg) {
        return new CatherineShulmansQuotesError_1.CatherineShulmansQuotesError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
