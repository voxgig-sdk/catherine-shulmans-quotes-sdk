...
local function make_error_util(ctx, err)
  ...
  local msg = "CatherineShulmansQuotesSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CatherineShulmansQuotesError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == CatherineShulmansQuotesError then
