...
local GithubAnalyticsEntity = {}
GithubAnalyticsEntity.__index = GithubAnalyticsEntity


function GithubAnalyticsEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GithubAnalyticsEntity)
  self._name = "github_analytics"
  self._client = client
...
function GithubAnalyticsEntity:get_name()
  return self._name
end


function GithubAnalyticsEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GithubAnalyticsEntity.new(self._client, opts)
end
...
function GithubAnalyticsEntity:mark_deleted()
  self._deleted = true
end


function GithubAnalyticsEntity:deleted()
  return true == self._deleted
end


function GithubAnalyticsEntity:data_set(args)
  if args ~= nil then
...
function GithubAnalyticsEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GithubAnalyticsEntity:match_set(args)
  if args ~= nil then
...
function GithubAnalyticsEntity:match_get()
...
function GithubAnalyticsEntity:stream(action, args, callopts)
...
---@param reqmatch GithubAnalyticsLoadMatch
---@param ctrl? table
---@return GithubAnalytics
---@return string? err
function GithubAnalyticsEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GithubAnalyticsEntity:_run_op(ctx, post_done)
  local utility = self._utility
