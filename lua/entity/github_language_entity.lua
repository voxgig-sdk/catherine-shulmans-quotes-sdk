...
local GithubLanguageEntity = {}
GithubLanguageEntity.__index = GithubLanguageEntity


function GithubLanguageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GithubLanguageEntity)
  self._name = "github_language"
  self._client = client
...
function GithubLanguageEntity:get_name()
  return self._name
end


function GithubLanguageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GithubLanguageEntity.new(self._client, opts)
end
...
function GithubLanguageEntity:mark_deleted()
  self._deleted = true
end


function GithubLanguageEntity:deleted()
  return true == self._deleted
end


function GithubLanguageEntity:data_set(args)
  if args ~= nil then
...
function GithubLanguageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GithubLanguageEntity:match_set(args)
  if args ~= nil then
...
function GithubLanguageEntity:match_get()
...
function GithubLanguageEntity:stream(action, args, callopts)
...
---@param reqmatch GithubLanguageLoadMatch
---@param ctrl? table
---@return GithubLanguage
---@return string? err
function GithubLanguageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GithubLanguageEntity:_run_op(ctx, post_done)
  local utility = self._utility
