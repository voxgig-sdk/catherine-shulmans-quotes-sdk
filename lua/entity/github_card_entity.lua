...
local GithubCardEntity = {}
GithubCardEntity.__index = GithubCardEntity


function GithubCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GithubCardEntity)
  self._name = "github_card"
  self._client = client
...
function GithubCardEntity:get_name()
  return self._name
end


function GithubCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GithubCardEntity.new(self._client, opts)
end
...
function GithubCardEntity:mark_deleted()
  self._deleted = true
end


function GithubCardEntity:deleted()
  return true == self._deleted
end


function GithubCardEntity:data_set(args)
  if args ~= nil then
...
function GithubCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GithubCardEntity:match_set(args)
  if args ~= nil then
...
function GithubCardEntity:match_get()
...
function GithubCardEntity:stream(action, args, callopts)
...
---@param reqmatch GithubCardLoadMatch
---@param ctrl? table
---@return GithubCard
---@return string? err
function GithubCardEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GithubCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
