...
describe("GithubAnalyticsDirect", function()
  it("should direct-load-github_analytics", function()
    local setup = github_analytics_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-github_analytics", setup.live and "live" or "unit")
