...
local SDK_MODULE = "catherine-shulmans-quotes_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["api"] = { ["test01"] = { id = "test01" } }, ["episode"] = { ["test01"] = { id = "test01" } }, ["github_analytics"] = { ["test01"] = { id = "test01" } }, ["github_card"] = { ["test01"] = { id = "test01" } }, ["github_language"] = { ["test01"] = { id = "test01" } }, ["quote"] = { ["test01"] = { id = "test01" } } } }'
