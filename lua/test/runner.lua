...
function runner.env_override(m)
  local live = runner.getenv("CATHERINE_SHULMANS_QUOTES_TEST_LIVE")
  local override = runner.getenv("CATHERINE_SHULMANS_QUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CATHERINE_SHULMANS_QUOTES_TEST_EXPLAIN")
