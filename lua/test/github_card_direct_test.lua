...
describe("GithubCardDirect", function()
  it("should direct-load-github_card", function()
    local setup = github_card_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-github_card", setup.live and "live" or "unit")
