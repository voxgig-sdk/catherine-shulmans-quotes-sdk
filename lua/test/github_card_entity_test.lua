...
describe("GithubCardEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CATHERINESHULMANSQUOTES_TEST_GITHUB_CARD_ENTID JSON to run live")
      return
    end
...
function github_card_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CATHERINESHULMANSQUOTES_TEST_GITHUB_CARD_ENTID")
