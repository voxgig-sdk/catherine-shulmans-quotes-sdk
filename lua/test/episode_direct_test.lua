...
describe("EpisodeDirect", function()
  it("should direct-list-episode", function()
    local setup = episode_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-episode", setup.live and "live" or "unit")
