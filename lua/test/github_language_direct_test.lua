...
describe("GithubLanguageDirect", function()
  it("should direct-load-github_language", function()
    local setup = github_language_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-github_language", setup.live and "live" or "unit")
