...
func registerSDKWords(r *eng.Registry, client *sdk.CatherineShulmansQuotesSDK) {
...
func runOp(client *sdk.CatherineShulmansQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
