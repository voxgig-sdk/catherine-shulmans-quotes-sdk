# CatherineShulmansQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CatherineShulmansQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CatherineShulmansQuotesSDK(...) and CatherineShulmansQuotesSDK.test(...) become
#      CatherineShulmansQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "catherineshulmansquotes_sdk"
_SDK_CLASS = "CatherineShulmansQuotesSDK"
...
_ENTITIES = {
    "Api": "api",
    "Episode": "episode",
    "GithubAnalytics": "github_analytics",
    "GithubCard": "github_card",
