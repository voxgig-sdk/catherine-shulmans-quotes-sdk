...
from catherineshulmansquotes_sdk.catherineshulmansquotes_types import (
    GithubAnalytics,
...
class GithubAnalyticsEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GithubAnalyticsEntity(self._client, opts)
    ...
    def data_get(self) -> GithubAnalytics:
    ...
    def match_get(self) -> GithubAnalytics:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GithubAnalytics:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GithubAnalytics().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
