...
from catherineshulmansquotes_sdk.core.control import CatherineShulmansQuotesControl
...
from catherineshulmansquotes_sdk.core.helpers import get_ctx_prop, to_map
...
class CatherineShulmansQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CatherineShulmansQuotesControl()
        ...
        if isinstance(sp, CatherineShulmansQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CatherineShulmansQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CatherineShulmansQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CatherineShulmansQuotesOperation({})
        ...
        op = CatherineShulmansQuotesOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return CatherineShulmansQuotesError(code, msg, self)
