# CatherineShulmansQuotes Python SDK Reference

Complete API reference for the CatherineShulmansQuotes Python SDK.
...
client = CatherineShulmansQuotesSDK(options)
```
...
#### `CatherineShulmansQuotesSDK.test(testopts=None, sdkopts=None)`
...
#### `GithubAnalytics(data=None)`

Create a new `GithubAnalyticsEntity` instance. Pass `None` for no initial data.

#### `GithubCard(data=None)`

Create a new `GithubCardEntity` instance. Pass `None` for no initial data.

#### `GithubLanguage(data=None)`

Create a new `GithubLanguageEntity` instance. Pass `None` for no initial data.
...
Create a new `GithubAnalyticsEntity` instance with the same options.
...
Create a new `GithubCardEntity` instance with the same options.
...
Create a new `GithubLanguageEntity` instance with the same options.
