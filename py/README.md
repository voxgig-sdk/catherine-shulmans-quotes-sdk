# CatherineShulmansQuotes Python SDK



The Python SDK for the CatherineShulmansQuotes API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/catherine-shulmans-quotes-sdk/releases)) or
...
```python
client = CatherineShulmansQuotesSDK.test(testopts, sdkopts)
```
...
Create an instance: `github_analytics = client.GithubAnalytics()`
...
Create an instance: `github_card = client.GithubCard()`
...
Create an instance: `github_language = client.GithubLanguage()`
...
```
py/
├── catherineshulmansquotes_sdk.py         -- Main SDK module
...
The main module (`catherineshulmansquotes_sdk`) exports the SDK class.
