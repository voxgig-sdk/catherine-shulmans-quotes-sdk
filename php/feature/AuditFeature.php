...
// CatherineShulmansQuotes SDK audit feature
...
class CatherineShulmansQuotesAuditFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _emit(CatherineShulmansQuotesContext $ctx, string $outcome): void
    {
