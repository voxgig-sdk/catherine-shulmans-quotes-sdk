...
// CatherineShulmansQuotes SDK clienttrack feature
...
class CatherineShulmansQuotesClienttrackFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    public function PostConstruct(CatherineShulmansQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CatherineShulmansQuotes-SDK';
