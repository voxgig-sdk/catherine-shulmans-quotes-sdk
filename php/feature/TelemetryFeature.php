...
// CatherineShulmansQuotes SDK telemetry feature
...
class CatherineShulmansQuotesTelemetryFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _close(CatherineShulmansQuotesContext $ctx, bool $ok): void
    {
