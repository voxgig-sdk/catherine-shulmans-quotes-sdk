...
// CatherineShulmansQuotes SDK cache feature
...
class CatherineShulmansQuotesCacheFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _through(CatherineShulmansQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
