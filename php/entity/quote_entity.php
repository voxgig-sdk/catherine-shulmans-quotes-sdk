...
// CatherineShulmansQuotes SDK Quote entity
...
class QuoteEntity
{
     ...
     * Load a single Quote.
     *
     * @param QuoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed QuoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Quote|array The loaded Quote as an assoc-array at the
