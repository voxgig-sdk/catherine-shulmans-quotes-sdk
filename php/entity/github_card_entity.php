...
// CatherineShulmansQuotes SDK GithubCard entity
...
class GithubCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GithubCardEntity($this->_client, $opts);
    }

    /**
     * @param GithubCard|array $args GithubCard data (assoc-array) to store.
     */
    ...
    /**
     * @return GithubCard|array The current GithubCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GithubCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GithubCard fields).
     */
    ...
    /**
     * Load a single GithubCard.
     *
     * @param GithubCardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GithubCardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GithubCard|array The loaded GithubCard as an assoc-array at the
