...
// CatherineShulmansQuotes SDK Episode entity
...
class EpisodeEntity
{
     ...
     *
     * @param EpisodeListMatch|array|null $reqmatch Match filter (any subset
     *   of Episode fields) as an assoc-array; EpisodeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Episode[]|array A list of Episode items as assoc-arrays at
     *   the SDK boundary; throws CatherineShulmansQuotesError on failure (item-5 convention).
     */
