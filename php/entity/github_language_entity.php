...
// CatherineShulmansQuotes SDK GithubLanguage entity
...
class GithubLanguageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GithubLanguageEntity($this->_client, $opts);
    }

    /**
     * @param GithubLanguage|array $args GithubLanguage data (assoc-array) to store.
     */
    ...
    /**
     * @return GithubLanguage|array The current GithubLanguage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GithubLanguage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GithubLanguage fields).
     */
    ...
    /**
     * Load a single GithubLanguage.
     *
     * @param GithubLanguageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GithubLanguageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GithubLanguage|array The loaded GithubLanguage as an assoc-array at the
