...
class QuoteEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function quote_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CATHERINE_SHULMANS_QUOTES_TEST_QUOTE_ENTID"]);
