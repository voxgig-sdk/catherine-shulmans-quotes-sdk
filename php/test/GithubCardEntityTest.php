...
class GithubCardEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_CARD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function github_card_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_CARD_ENTID");
