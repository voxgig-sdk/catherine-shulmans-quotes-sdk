...
// CatherineShulmansQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CatherineShulmansQuotesSDK::test)
...
{
    private const SDK_CLASS = 'CatherineShulmansQuotesSDK';
    ...
    private const SDK_BASE = 'catherineshulmansquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../catherineshulmansquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
