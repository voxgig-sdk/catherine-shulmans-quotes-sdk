...
class GithubCardDirectTest extends TestCase
{
    public function test_direct_load_github_card(): void
    {
        $setup = github_card_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-github_card", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function github_card_direct_setup($mockres)
{
