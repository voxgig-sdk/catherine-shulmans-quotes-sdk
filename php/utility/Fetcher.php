...
// CatherineShulmansQuotes SDK utility: fetcher

class CatherineShulmansQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CatherineShulmansQuotesSDK/1.0)';
    ...
    public static function call(CatherineShulmansQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
