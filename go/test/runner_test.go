...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("CATHERINESHULMANSQUOTES_TEST_LIVE") == "TRUE" ||
		os.Getenv("CATHERINESHULMANSQUOTES_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("CATHERINESHULMANSQUOTES_TEST_EXPLAIN"); explain != "" {
