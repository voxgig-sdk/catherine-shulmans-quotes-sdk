...
const testSeed = `map[string]any{"entity": map[string]any{"api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "github_analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "github_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "github_language": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
