...
func TestGithubLanguageEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		githubLanguageRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.github_language")))
...
func github_languageBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_LANGUAGE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["CATHERINE_SHULMANS_QUOTES_TEST_GITHUB_LANGUAGE_ENTID"])
