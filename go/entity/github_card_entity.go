...
func NewGithubCardEntity(client *core.CatherineShulmansQuotesSDK, entopts map[string]any) *GithubCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GithubCardEntity) GetName() string { return e.name }
...
func (e *GithubCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GithubCardEntity) Deleted() bool {
	return e.deleted
}


func (e *GithubCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGithubCardEntity(e.client, opts)
}

func (e *GithubCardEntity) Data(args ...any) any {
...
func (e *GithubCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GithubCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GithubCardEntity) DataTyped(data ...GithubCard) GithubCard {
	if len(data) > 0 {
		return typedFrom[GithubCard](e.Data(asMap(data[0])))
	}
	return typedFrom[GithubCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GithubCard (all fields
// optional at the wire level).
func (e *GithubCardEntity) MatchTyped(match ...GithubCard) GithubCard {
	if len(match) > 0 {
		return typedFrom[GithubCard](e.Match(asMap(match[0])))
	}
	return typedFrom[GithubCard](e.Match())
}
...
func (e *GithubCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GithubCardEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GithubCardLoadMatch and returns an GithubCard. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GithubCardEntity) LoadTyped(reqmatch GithubCardLoadMatch, ctrl map[string]any) (GithubCard, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GithubCard{}, err
	}
	return typedFrom[GithubCard](res), nil
}



func (e *GithubCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GithubCardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GithubCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GithubCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GithubCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
