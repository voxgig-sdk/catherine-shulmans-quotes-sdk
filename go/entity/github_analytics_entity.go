...
type GithubAnalyticsEntity struct {
	name    string
	client  *core.CatherineShulmansQuotesSDK
...
func NewGithubAnalyticsEntity(client *core.CatherineShulmansQuotesSDK, entopts map[string]any) *GithubAnalyticsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GithubAnalyticsEntity) GetName() string { return e.name }
...
func (e *GithubAnalyticsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GithubAnalyticsEntity) Deleted() bool {
	return e.deleted
}


func (e *GithubAnalyticsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGithubAnalyticsEntity(e.client, opts)
}

func (e *GithubAnalyticsEntity) Data(args ...any) any {
...
func (e *GithubAnalyticsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GithubAnalytics; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GithubAnalyticsEntity) DataTyped(data ...GithubAnalytics) GithubAnalytics {
	if len(data) > 0 {
		return typedFrom[GithubAnalytics](e.Data(asMap(data[0])))
	}
	return typedFrom[GithubAnalytics](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GithubAnalytics (all fields
// optional at the wire level).
func (e *GithubAnalyticsEntity) MatchTyped(match ...GithubAnalytics) GithubAnalytics {
	if len(match) > 0 {
		return typedFrom[GithubAnalytics](e.Match(asMap(match[0])))
	}
	return typedFrom[GithubAnalytics](e.Match())
}
...
func (e *GithubAnalyticsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GithubAnalyticsEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GithubAnalyticsLoadMatch and returns an GithubAnalytics. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GithubAnalyticsEntity) LoadTyped(reqmatch GithubAnalyticsLoadMatch, ctrl map[string]any) (GithubAnalytics, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GithubAnalytics{}, err
	}
	return typedFrom[GithubAnalytics](res), nil
}



func (e *GithubAnalyticsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GithubAnalyticsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GithubAnalyticsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GithubAnalyticsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GithubAnalyticsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
