...
type GithubLanguageEntity struct {
	name    string
...
func NewGithubLanguageEntity(client *core.CatherineShulmansQuotesSDK, entopts map[string]any) *GithubLanguageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GithubLanguageEntity) GetName() string { return e.name }
...
func (e *GithubLanguageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GithubLanguageEntity) Deleted() bool {
	return e.deleted
}


func (e *GithubLanguageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGithubLanguageEntity(e.client, opts)
}

func (e *GithubLanguageEntity) Data(args ...any) any {
...
func (e *GithubLanguageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GithubLanguage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GithubLanguageEntity) DataTyped(data ...GithubLanguage) GithubLanguage {
	if len(data) > 0 {
		return typedFrom[GithubLanguage](e.Data(asMap(data[0])))
	}
	return typedFrom[GithubLanguage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GithubLanguage (all fields
// optional at the wire level).
func (e *GithubLanguageEntity) MatchTyped(match ...GithubLanguage) GithubLanguage {
	if len(match) > 0 {
		return typedFrom[GithubLanguage](e.Match(asMap(match[0])))
	}
	return typedFrom[GithubLanguage](e.Match())
}
...
func (e *GithubLanguageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GithubLanguageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GithubLanguageLoadMatch and returns an GithubLanguage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GithubLanguageEntity) LoadTyped(reqmatch GithubLanguageLoadMatch, ctrl map[string]any) (GithubLanguage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GithubLanguage{}, err
	}
	return typedFrom[GithubLanguage](res), nil
}



func (e *GithubLanguageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GithubLanguageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GithubLanguageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GithubLanguageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GithubLanguageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
