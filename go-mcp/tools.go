...
type Args struct {
	Entity string         `json:"entity" jsonschema:"api | episode | github_analytics | github_card | github_language | quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CatherineShulmansQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "catherine-shulmans-quotes_list",
		Description: "List records from CatherineShulmansQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "catherine-shulmans-quotes_load",
		Description: "Load a single record from CatherineShulmansQuotes. " +
...
func runOp(client *sdk.CatherineShulmansQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CatherineShulmansQuotesSDK, name string) (sdk.CatherineShulmansQuotesEntity, error) {
	...
	case "github_analytics":
		return client.GithubAnalytics(nil), nil
	case "github_card":
		return client.GithubCard(nil), nil
	case "github_language":
		return client.GithubLanguage(nil), nil
	case "quote":
