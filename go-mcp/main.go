// Command CatherineShulmansQuotes-mcp is an MCP server exposing the CatherineShulmansQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CatherineShulmansQuotes_list  — list records of an entity
//	CatherineShulmansQuotes_load  — load a single record of an entity
//
