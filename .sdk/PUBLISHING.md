...
|---|---|---|
| `ts/` | @voxgig-sdk/catherine-shulmans-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/catherine-shulmans-quotes-sdk \
      --repository voxgig-sdk/catherine-shulmans-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/catherine-shulmans-quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/catherine-shulmans-quotes-sdk --id=<id>` removes it.
