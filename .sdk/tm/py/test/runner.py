...
class CatherineShulmansQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CatherineShulmansQuotesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CatherineShulmansQuotesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CatherineShulmansQuotesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
