# CatherineShulmansQuotes SDK feature corpus test
#
...
def _client(kase):
    ...
    CatherineShulmansQuotesSDK(...), not CatherineShulmansQuotesSDK.test(...): the `test` feature is
    ...
    return CatherineShulmansQuotesSDK(opts)
