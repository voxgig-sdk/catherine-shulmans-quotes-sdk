...
// CatherineShulmansQuotes SDK utility: graphql
//
...
class CatherineShulmansQuotesGraphql
{
    ...
    // equivalent.
    public static function body(CatherineShulmansQuotesContext $ctx): mixed
    {
    ...
    public static function errors(CatherineShulmansQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
