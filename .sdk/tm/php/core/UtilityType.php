...
// CatherineShulmansQuotes SDK utility type

class CatherineShulmansQuotesUtility
{
    ...
    public static function copy(CatherineShulmansQuotesUtility $src): CatherineShulmansQuotesUtility
    {
        $u = new CatherineShulmansQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
