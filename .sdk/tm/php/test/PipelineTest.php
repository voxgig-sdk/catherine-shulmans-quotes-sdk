...
// CatherineShulmansQuotes SDK pipeline test
//
...
{
    private static function utility(): CatherineShulmansQuotesUtility
    {
        return new CatherineShulmansQuotesUtility();
    }
    ...
    private static function ctx(array $over = []): CatherineShulmansQuotesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CatherineShulmansQuotesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CatherineShulmansQuotesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CatherineShulmansQuotesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CatherineShulmansQuotesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CatherineShulmansQuotesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CatherineShulmansQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CatherineShulmansQuotesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CatherineShulmansQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CatherineShulmansQuotesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CatherineShulmansQuotesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CatherineShulmansQuotesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CatherineShulmansQuotesResponse([]),
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        [, $err] = CatherineShulmansQuotesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CatherineShulmansQuotesSpec([]),
            'response' => null,
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        [, $err] = CatherineShulmansQuotesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's']),
            'response' => new CatherineShulmansQuotesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        [, $err] = CatherineShulmansQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's']),
            'response' => new CatherineShulmansQuotesResponse(self::resp(200, ['v' => 1])),
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        [, $err] = CatherineShulmansQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's']),
            'response' => new CatherineShulmansQuotesResponse(self::resp(200, ['v' => 2])),
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CatherineShulmansQuotesMakeResponse::call($ctx);
    ...
    {
        $preset = new CatherineShulmansQuotesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CatherineShulmansQuotesSpec([]),
            'response' => new CatherineShulmansQuotesResponse([]),
            'result' => new CatherineShulmansQuotesResult([]),
        ...
        [$got, $err] = CatherineShulmansQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CatherineShulmansQuotesResult([])]);
        [, $err] = CatherineShulmansQuotesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CatherineShulmansQuotesSpec([]), 'result' => null]);
        [, $err] = CatherineShulmansQuotesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's']),
            'result' => new CatherineShulmansQuotesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CatherineShulmansQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CatherineShulmansQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's']),
            'result' => new CatherineShulmansQuotesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CatherineShulmansQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CatherineShulmansQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CatherineShulmansQuotesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CatherineShulmansQuotesSpec([]),
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CatherineShulmansQuotesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CatherineShulmansQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CatherineShulmansQuotesError('boom', 'boom');
        $utility->fetcher = function (CatherineShulmansQuotesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CatherineShulmansQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CatherineShulmansQuotesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CatherineShulmansQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CatherineShulmansQuotesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CatherineShulmansQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CatherineShulmansQuotesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CatherineShulmansQuotesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CatherineShulmansQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CatherineShulmansQuotesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CatherineShulmansQuotesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CatherineShulmansQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CatherineShulmansQuotesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CatherineShulmansQuotesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CatherineShulmansQuotesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CatherineShulmansQuotesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CatherineShulmansQuotesResult(['ok' => false])]);
        $this->expectException(CatherineShulmansQuotesError::class);
        CatherineShulmansQuotesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CatherineShulmansQuotesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CatherineShulmansQuotesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CatherineShulmansQuotesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CatherineShulmansQuotesBaseFeature();
        $b = new CatherineShulmansQuotesBaseFeature();
        CatherineShulmansQuotesFeatureAdd::call($ctx, $a);
        CatherineShulmansQuotesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CatherineShulmansQuotesBaseFeature
    {
        $f = new CatherineShulmansQuotesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CatherineShulmansQuotesFeatureAdd::call($ctx, self::named_feature('a'));
        CatherineShulmansQuotesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CatherineShulmansQuotesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CatherineShulmansQuotesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CatherineShulmansQuotesFeatureAdd::call($ctx, $replace);
        ...
        CatherineShulmansQuotesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CatherineShulmansQuotesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CatherineShulmansQuotesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CatherineShulmansQuotesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CatherineShulmansQuotesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CatherineShulmansQuotesResponse(['headers' => null]),
            'result' => new CatherineShulmansQuotesResult([]),
        ]);
        CatherineShulmansQuotesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CatherineShulmansQuotesResultBody::call($ctx);
