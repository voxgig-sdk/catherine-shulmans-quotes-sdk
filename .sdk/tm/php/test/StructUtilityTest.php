...
// CatherineShulmansQuotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CatherineShulmansQuotesOmni::makeStructRunner(
    ...
    {
        return CatherineShulmansQuotesOmni::objmodel(CatherineShulmansQuotesOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return CatherineShulmansQuotesOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return CatherineShulmansQuotesOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CatherineShulmansQuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(CatherineShulmansQuotesOmni::structfix($val, Struct::undef()))) {
