...
// CatherineShulmansQuotes SDK proxy feature
...
class CatherineShulmansQuotesProxyFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    public function init(CatherineShulmansQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CatherineShulmansQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
