...
// CatherineShulmansQuotes SDK streaming feature
...
class CatherineShulmansQuotesStreamingFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _iterate(CatherineShulmansQuotesResult $result): \Generator
    {
    ...
    private function _streamable(CatherineShulmansQuotesContext $ctx): bool
    {
