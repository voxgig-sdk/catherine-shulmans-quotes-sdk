...
// CatherineShulmansQuotes SDK netsim feature
...
class CatherineShulmansQuotesNetsimFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _simulate(CatherineShulmansQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CatherineShulmansQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
