...
// CatherineShulmansQuotes SDK timeout feature
...
class CatherineShulmansQuotesTimeoutFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _with_timeout(CatherineShulmansQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CatherineShulmansQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
