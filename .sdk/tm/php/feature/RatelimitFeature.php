...
// CatherineShulmansQuotes SDK ratelimit feature
...
class CatherineShulmansQuotesRatelimitFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _acquire(CatherineShulmansQuotesContext $ctx): void
    {
    ...
    private function _track(CatherineShulmansQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
