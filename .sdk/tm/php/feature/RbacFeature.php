...
// CatherineShulmansQuotes SDK rbac feature
...
class CatherineShulmansQuotesRbacFeature extends CatherineShulmansQuotesBaseFeature
{
    ...
    private function _required(CatherineShulmansQuotesContext $ctx): ?string
    {
    ...
    private function _reject(CatherineShulmansQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(CatherineShulmansQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
